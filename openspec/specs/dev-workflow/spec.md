...
Defines requirements for the development workflow infrastructure: multi-stage Docker builds to minimize production image size, a dev-mode compose file for rapid iteration without full rebuilds, and a configurable dashboard port via environment variable.
